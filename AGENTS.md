...
**[Domains](docs/lode/domains.md)**: what each part is for, the delivery spine, and the two controller families.

**[Practices](docs/lode/practices.md)**: the `Campsend.policy` extension point, one wide event per request, how to run the tests, and the compromises that are deliberate.
